      ...
      {photos.length > 0 && (
        <div className="mb-4 flex justify-end">
          <div className="group relative inline-flex">
            ...
            <span
              aria-hidden
              className="pointer-events-none absolute inset-0 animate-soft-ping rounded-sm bg-white/10 group-hover:hidden"
            />
            <span
              aria-hidden
              className="pointer-events-none absolute inset-0 animate-soft-ping rounded-sm bg-white/5 group-hover:hidden"
              style={{ animationDelay: "1.2s" }}
            />
            <button
              onClick={() => setPresentationIndex(0)}
              className="relative flex items-center gap-2 rounded-sm border border-white/20 bg-black/40 px-4 py-2 text-[11px] uppercase tracking-[0.15em] text-neutral-300 backdrop-blur-sm transition hover:border-white hover:text-white"
            >
      ...
      {showPresentLanding && (
        <div className="fixed inset-0 z-[150] flex flex-col items-center justify-center gap-6 bg-black/95 px-6 text-center">
          ...
          <button
            ...
            className="flex items-center gap-3 rounded-full bg-white px-8 py-4 text-base font-light tracking-wide text-black shadow-[0_0_24px_rgba(255,255,255,0.12)] transition hover:scale-[1.04] active:scale-[0.97]"
          >
