...
export function PhotoCard({
  ...
  return (
    <div
      className={`group relative cursor-pointer overflow-hidden bg-neutral-950 transition ${
    ...
    >
      ...
      {menuOpen && (
        <>
          ...
          />
          <div className="absolute right-1 top-10 z-40 w-44 rounded-sm border border-white/10 bg-neutral-950 py-1 shadow-xl">
            {onAddToCollection && (
              <button
                onClick={(e) => {
                  e.stopPropagation();
